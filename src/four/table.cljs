...
(def elements [{:element/symbol "H",
               ...
               {:element/symbol "B", :element/name "Boron", :element/weight "10.811"}
               {:element/symbol "C",
                :element/name "Carbon",
               ...
               {:element/symbol "Fe", :element/name "Iron", :element/weight "55.845"}
               {:element/symbol "Co",
                :element/name "Cobalt",
               ...
               {:element/symbol "Zn", :element/name "Zinc", :element/weight "65.38"}
               {:element/symbol "Ga",
               ...
               {:element/symbol "Sn", :element/name "Tin", :element/weight "118.71"}
               {:element/symbol "Sb",
               ...
               {:element/symbol "Pb", :element/name "Lead", :element/weight "207.2"}
               {:element/symbol "Bi",
               ...
               {:element/symbol "At",
                ...
                :element/weight "(210)"}
               {:element/symbol "Rn", :element/name "Radon", :element/weight "(222)"}
               {:element/symbol "Fr",
